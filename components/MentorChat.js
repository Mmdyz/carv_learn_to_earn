...
export default function MentorChat({ onAsk }) {
  ...
  const fallbackReply = `Hey buddy 👋  
I am Elesha, your CARV Mentor — a fusion of human insight and AI clarity.  
...
Feel free to check the community tab to get the latest updates. I'll be back soon ⚡`;
    ...
    <div className="space-y-3">
      ...
      <div className="flex gap-2">
        <input
          ...
          placeholder="Ask Elesha anything about CARV, SVM Chain, or Web3..."
        />
        <button
          onClick={handleAsk}
      ...
      <div className="flex items-start gap-3 bg-[#101524] border border-gray-800 rounded-xl p-4 text-sm min-h-[80px] text-gray-300 transition-all duration-500">
        ...
        <div className="flex-1">
          {isThinking ? (
            <p className="text-cyan-400 animate-pulse">Elesha is processing{dots}</p>
          ) : (
