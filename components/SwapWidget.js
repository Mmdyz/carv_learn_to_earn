    ...
    <div className="flex flex-col gap-6 text-gray-100">
      ...
      <div className="bg-[#101524] border border-gray-800 rounded-xl p-4 text-center space-y-3">
        <p className="text-gray-400 text-sm">
          💱 Swapping between CARV and USDT will be available soon on the CARV
          SVM Chain.
        </p>

        <button
          disabled
          className="w-full bg-gray-800 text-gray-500 border border-gray-700 rounded py-2 font-semibold cursor-not-allowed"
        >
          Get Quote (Disabled)
        </button>
