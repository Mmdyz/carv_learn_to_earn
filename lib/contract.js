...
export async function logQuestCompletion(walletAdapter, questId) {
  try {
    ...
    toast((t) => (
      <div>
        <p className="font-medium text-white">✅ Quest successfully logged!<br></br>View Transaction:</p>
        <a
          href={`https://solscan.io/tx/${signature}?cluster=custom&customUrl=https://rpc.testnet.carv.io/rpc`}
          target="_blank"
